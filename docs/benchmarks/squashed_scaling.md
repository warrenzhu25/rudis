...
This document records the full 60-second scaling benchmark suite of `rudis` across 1, 2, 4, 8, 16, and 32 worker threads after implementing **pipeline squashing**, **pre-allocated responder pools**, and **`mimalloc` zero-lock cross-core allocation**.
...
2. **Behavior at 32 Cores**:
   ...
   - Throughput settles at a stable **2.47M Ops/sec** and **2.52 GB/sec**.
